  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="" size="2xl">
      <div className="max-h-[90vh] overflow-y-auto bg-gray-50 dark:bg-slate-950">
              ...
              <div className="grid grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <p className="text-gray-800 dark:text-gray-200 font-bold text-sm mt-0.5">
                    {localPayslip?.total_hours ?? '0'} hrs
                  </p>
                </div>
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-gray-800 dark:text-gray-200 text-xs font-bold">
                        ₱{toNumber(localPayslip?.sss_deduction).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-gray-800 dark:text-gray-200 text-xs font-bold">
                        ₱{toNumber(localPayslip?.philhealth_deduction).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-gray-800 dark:text-gray-200 text-xs font-bold">
                        ₱{toNumber(localPayslip?.pagibig_deduction).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                      </span>
                    </div>
                  </div>
                </div>
        ...
        {/* FOOTER ACTIONS */}
        <div className="p-6 border-t border-gray-200 dark:border-slate-800 bg-gray-100/50 dark:bg-slate-900/50 rounded-b-lg flex gap-3 justify-end">
          <button
            onClick={onClose}
